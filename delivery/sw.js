/* ============================================================================
   ...
   ========================================================================== */
const CACHE = 'sridhar-rush-v76';

const CORE = [
  '/', '/controller',
  '/css/style.css?v=76', '/css/controller.css?v=76',
  '/js/game-core.js?v=76', '/js/progression.js?v=76', '/js/cosmetics.js?v=76', '/js/net.js?v=76', '/js/game.js?v=76', '/js/controller.js?v=76', '/js/account.js?v=76', '/js/i18n.js?v=76',
  ...
  '/manifest.webmanifest', '/manifest-controller.webmanifest', '/replay', '/js/replay.js?v=76',
