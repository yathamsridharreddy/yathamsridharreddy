/* ============================================================================
   ...
   ========================================================================== */
const CACHE = 'sridhar-rush-v71';

const CORE = [
  '/', '/controller',
  '/css/style.css?v=71', '/css/controller.css?v=71',
  '/js/game-core.js?v=71', '/js/net.js?v=71', '/js/game.js?v=71', '/js/controller.js?v=71', '/js/account.js?v=71', '/js/i18n.js?v=71',
  ...
  '/manifest.webmanifest', '/manifest-controller.webmanifest', '/replay', '/js/replay.js?v=71',
