/* ============================================================================
   ...
   ========================================================================== */
const CACHE = 'sridhar-rush-v45';

const CORE = [
  '/', '/controller',
  '/css/style.css?v=45', '/css/controller.css?v=45',
  '/js/game-core.js?v=45', '/js/net.js?v=45', '/js/game.js?v=45', '/js/controller.js?v=45', '/js/account.js?v=45', '/js/i18n.js?v=45',
