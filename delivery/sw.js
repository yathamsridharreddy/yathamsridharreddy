/* ============================================================================
   ...
   ========================================================================== */
const CACHE = 'sridhar-rush-v37';

const CORE = [
  '/', '/controller',
  '/css/style.css?v=37', '/css/controller.css?v=37',
  '/js/game-core.js?v=37', '/js/net.js?v=37', '/js/game.js?v=37', '/js/controller.js?v=37', '/js/account.js?v=37',
