/* ============================================================================
   ...
   ========================================================================== */
const CACHE = 'sridhar-rush-v72';

const CORE = [
  '/', '/controller',
  '/css/style.css?v=72', '/css/controller.css?v=72',
  '/js/game-core.js?v=72', '/js/net.js?v=72', '/js/game.js?v=72', '/js/controller.js?v=72', '/js/account.js?v=72', '/js/i18n.js?v=72',
  ...
  '/manifest.webmanifest', '/manifest-controller.webmanifest', '/replay', '/js/replay.js?v=72',
